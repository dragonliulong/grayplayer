...
QT_MOC_LITERAL(1, 7, 4), // "skip"
QT_MOC_LITERAL(2, 12, 0), // ""
QT_MOC_LITERAL(3, 13, 3), // "per"
QT_MOC_LITERAL(4, 17, 11), // "can_give_up"
QT_MOC_LITERAL(5, 29, 14), // "setSliderPress"
QT_MOC_LITERAL(6, 44, 16), // "setSliderRelease"
QT_MOC_LITERAL(7, 61, 12), // "timeoutEvent"
QT_MOC_LITERAL(8, 74, 5), // "style"
QT_MOC_LITERAL(9, 80, 11) // "SliderStyle"

    },
    "Slider\0skip\0\0per\0can_give_up\0"
    "setSliderPress\0setSliderRelease\0"
    "timeoutEvent\0style\0SliderStyle"
};
...
void Slider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->skip((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        case 1: _t->setSliderPress(); break;
        case 2: _t->setSliderRelease(); break;
        case 3: _t->timeoutEvent(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Slider::*)(double , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Slider::skip)) {
                *result = 0;
                return;
            }
        }
        ...
        case 0:
            *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< SliderStyle >(); break;
        }
    }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< SliderStyle*>(_v) = _t->GetStyle(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->SetStyle(*reinterpret_cast< SliderStyle*>(_v)); break;
        default: break;
        }
...
// SIGNAL 0
void Slider::skip(double _t1, bool _t2)
{
