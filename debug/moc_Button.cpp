...
QT_MOC_LITERAL(2, 13, 11) // "ButtonColor"

    },
    "Button\0color\0ButtonColor"
};
...
void Button::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::RegisterPropertyMetaType) {
        ...
        case 0:
            *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< ButtonColor >(); break;
        }
    }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< ButtonColor*>(_v) = _t->GetColor(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->SetColor(*reinterpret_cast< ButtonColor*>(_v)); break;
        default: break;
        }
